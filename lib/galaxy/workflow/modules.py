...
class InputParameterModule(WorkflowModule):
    ...
    def get_inputs(self):
        ...
        for param_type in ["text", "integer"]:
            if param_type == "text":
                ...
                input_default_value = IntegerToolParameter(None, XML(
                    ...
                    ''' %  (parameter_def.get("default", None) or '')))
            ...
            when_specify_default_true.inputs = odict()
            ...
            when_specify_default_false.inputs = odict()
        ...
        # ("optional", ),
        return OrderDictionary([("parameter_definition", parameter_type_cond)])
