...
class InputParameterModule(WorkflowModule):
    ...
    def get_inputs(self):
        ...
        for param_type in ["text", "integer", "float", "boolean", "color"]:
            default_source: Dict[str, Union[int, float, bool, str]] = dict(name="default", label="Default Value", type=param_type)
            if param_type == "text":
                ...
                input_default_value: Union[TextToolParameter, IntegerToolParameter, FloatToolParameter, BooleanToolParameter, ColorToolParameter] = TextToolParameter(None, default_source)
            ...
            if param_type == "text":
                restrict_how_source: Union[Dict[str, Union[str, List[Dict[str, Union[str, bool]]]]]] = dict(name="how", label="Restrict Text Values?", type="select")
